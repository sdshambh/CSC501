...
*/
	maxaddr = (char *)( 1024 * NBPG - 1); /* 10M size */ //Changed this because after 1024 page number we have frames and backing store
															//so the heap and stack can't go beyond this address
